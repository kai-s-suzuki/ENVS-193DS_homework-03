...
The paper I chose for my critique uses a linear model, with nest abundance as the response variable and year as the predictor variable. ![Leatherback nesting model](https://ars.els-cdn.com/content/image/1-s2.0-S2351989425000162-gr4_lrg.jpg)
